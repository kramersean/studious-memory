...
- PARA heuristics default to Resources unless clear project finish lines exist, and attach area hints when detected
...
- `DELETE /notes/{id}` – remove a note entirely
